...
namespace ConsoleApp13.Models
{
    public partial class northwindContext : DbContext
    {
        ...
        public virtual DbSet<CustomersFake> CustomersFakes { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("server=CANR2-4;database=northwind;trusted_connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomersFake>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("CustomersFake");
